...
import { mdiUpload, mdiPlay, mdiStop, mdiDownload } from "@mdi/js";
        ...
        {mixComplete && audioUrl && !mixing && (
          <div className="flex flex-col items-center mt-3 w-full">
            ...
            <a
              ...
              className="mt-4 bg-cyan-500 text-white font-semibold py-2 px-4 rounded-2xl hover:bg-cyan-600 transition-all duration-300"
            >
