...
def dynamic_crossfade(song1, song2, transition_point, fade_duration=3000, song1_name="Song 1", song2_name="Song 2"):
    ...
    fade_out_segment.export(f"fade_out_{song1_name}.mp3", format="mp3")  # Export fade-out part
    ...
    fade_in_segment.export(f"fade_in_{song2_name}.mp3", format="mp3")  # Export fade-in part
    ...
    first_part.export(f"first_part_{song1_name}.mp3", format="mp3")  # Export first part
    
    # The second part is from song2 after the fade-in
    second_part = song2[fade_in_end:]  # After the fade-in
    second_part.export(f"second_part_{song2_name}.mp3", format="mp3")  # Export second part
